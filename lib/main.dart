...
const request =
    "https://api.hgbrasil.com/finance?format=json-cors&key=bc7a1c6f";
...
class _HomeState extends State<Home> {
  ...
  void _realChanged(String text){
    ...
    dolarController.text = (real/dolar).toStringAsFixed(1);
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Divider(),
                          buildTextField("Bitcoin", "B\$", bitcoinController, _bitcoinChanged)
                        ],
                      ),
                    )
                  );
...
Widget buildTextField(String label, String prefix, TextEditingController controller, Function value){
  return TextField(
